...
<head>
    ...
    <title>HubPay - Sign In</title>
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600;700&display=swap" rel="stylesheet">
    <style>
        /* Same styles as sign up, reusing for consistency */
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="left-section">
        <img src="../images/Dollario-logo.png" alt="HubPay Logo" class="logo">
    ...
    <div class="right-section">
        ...
        <p class="terms">By signing in, you agree to our <a href="#">Terms and Conditions</a> &amp; <a href="#">Privacy
                Policy</a>.</p>
    </div>
    ...
    <script>
        document.querySelector('form').addEventListener('submit', function (e) {
            ...
            // Show an "OK" popup using built-in confirm or alert
