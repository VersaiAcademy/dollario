    ...
    <style>
        ...
        * {
        ...
        .hero {
            ...
            background: url('admin/uploads/backgroundimg.png') no-repeat center center;
            background-size: cover;
    ...
    <header>
        <nav class="nav-container">
            <div class="sidebar-header">
                <img src="admin/uploads/Dollario-logo .svg" alt="Logo">
            </div>
            <div class="nav-links">
    ...
    <section class="hero">
        <div class="hero-container">
            ...
            <div class="price-ticker">
                <div class="rupeee">
                    <img src="admin/uploads/golden-coin.png" alt="rupee-img">
                </div>
